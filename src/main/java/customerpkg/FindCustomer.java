...
public class FindCustomer extends javax.swing.JFrame {
    ...
    private void ViewButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ViewButtonActionPerformed
        ...
        if(row<0){
            JOptionPane.showMessageDialog(this, "You must select an Customer", "Error", JOptionPane.ERROR_MESSAGE);
        }
        else{
            try {
    ...
    private void DeleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteButtonActionPerformed
        ...
        int res= JOptionPane.showConfirmDialog(this, "Delete this Customer?", "Confirm",JOptionPane.YES_NO_OPTION ,JOptionPane.QUESTION_MESSAGE);
