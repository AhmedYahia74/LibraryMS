...
public class FindBook extends javax.swing.JFrame {
    ...
    private void SearchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchButtonActionPerformed
        try {
            ArrayList<Book> lst = BookDAO.Search(SearchField.getText());
    ...
    private void ViewButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ViewButtonActionPerformed
        ...
        if (row < 0) {
            ...
            try {
                Book e = BookDAO.Search("" + Table.getValueAt(row, 2)).get(0);
                ViewBook v = new ViewBook(FindBook.this, e, true);
                v.setVisible(true);
            } catch (SQLException ex) {
                Logger.getLogger(FindBook.class.getName()).log(Level.SEVERE, null, ex);
            } catch (IOException ex) {
